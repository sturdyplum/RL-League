...
# source: league_runner/runner_service.proto
...
_AGENTRESPONSE.fields_by_name['agents'].message_type = shared_dot_games__pb2._AGENT
_GAMERESPONSE.fields_by_name['games'].message_type = shared_dot_games__pb2._GAME
_REPORTREQUEST.fields_by_name['results'].message_type = shared_dot_games__pb2._GAMERESULT
...
AgentRequest = _reflection.GeneratedProtocolMessageType('AgentRequest', (_message.Message,), {
  ...
  '__module__' : 'league_runner.runner_service_pb2'
